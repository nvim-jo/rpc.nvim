...
return {
    ...
    [".zshenv"] = { ".zshenv", "shell" },
    [".zshrc"] = { ".zshrc", "shell" },
    ["bun.lockb"] = { "Editing a LOCKB file", "https://i.ibb.co/0fsCJyC/bun-new-icon.png" },
    ...
    ["package.json"] = { "Editing a JSON file", "https://i.ibb.co/Sw11fpr/package-json-new-icon.png" },
    ...
    ["tsconfig.json"] = { "Editing a JSON file", "https://i.ibb.co/yBFNtwD/tsconfig-new-icon.png" },
    ...
    java = { "Java", "java" },
    jl = { "Julia", "julia" },
    js = { "Editing a JAVASCRIPT file", "https://i.ibb.co/NLpxtGQ/javascript-new-icon.png" },
    json = { "Editing a JSON file", "https://i.ibb.co/JCwJXNL/json-new-icon.png" },
    jsx = { "React", "react" },
    ...
    py = { "Editing a PYTHON file", "https://i.ibb.co/vxfJNfG/python-new-icon.png" },
    r = { "R", "r" },
    raku = { "Raku", "raku" },
    rakudoc = { "Raku", "raku" },
    rakumod = { "Raku", "raku" },
    ...
    rkt = { "Racket", "racket"},
    rs = { "Editing a RUST file", "https://i.ibb.co/vV9NP5v/rust-new-icon.png" },
    sass = { "Sass", "sass" },
    scala = { "Scala", "scala" },
    scm = { "Scheme", "scheme" },
    scss = { "Sass", "scss" },
    ...
    tl = { "Teal", "teal" },
    toml = { "TOML", "toml" },
    ts = { "Editing a TYPESCRIPT file", "https://i.ibb.co/hHtrPLp/ts-new-icon.png" },
    tsx = { "React", "react" },
    txt = { "Text file", "text" },
    ...
    xslt = { "XSLT", "markup" },
    yaml = { "Editing a YAML file", "https://i.ibb.co/x3RQ5MF/yaml-new-icon.png" },
    yml = { "Editing a YAML file", "https://i.ibb.co/x3RQ5MF/yaml-new-icon.png" },
    zig = { "Zig", "zig" },
