...
return {
    ...
    py = { "Python", "https://i.ibb.co/vxfJNfG/python-new-icon.png" },
    r = { "R", "r" },
    raku = { "Raku", "raku" },
    rakudoc = { "Raku", "raku" },
    rakumod = { "Raku", "raku" },
    ...
    rkt = { "Racket", "racket"},
    rs = { "Rust", "https://i.ibb.co/vV9NP5v/rust-new-icon.png" },
    sass = { "Sass", "sass" },
    scala = { "Scala", "scala" },
    scm = { "Scheme", "scheme" },
    scss = { "Sass", "scss" },
    ...
    tl = { "Teal", "teal" },
    toml = { "TOML", "toml" },
    ts = { "TypeScript", "https://i.ibb.co/hHtrPLp/ts-new-icon.png" },
    tsx = { "React", "react" },
    txt = { "Text file", "text" },
    ...
    xslt = { "XSLT", "markup" },
    yaml = { "YAML", "https://i.ibb.co/x3RQ5MF/yaml-new-icon.png" },
    yml = { "YAML", "https://i.ibb.co/x3RQ5MF/yaml-new-icon.png" },
    zig = { "Zig", "zig" },
