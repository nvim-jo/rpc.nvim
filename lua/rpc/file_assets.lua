...
return {
    ...
    ["package.json"] = { "Editing a JSON file", "packagejson" },
    ["poetry.lock"] = { "Editing a LOCK file", "pythonlock" },
    ["prettier.config.cjs"] = { "Prettier", "prettier" },
    ["prettier.config.js"] = { "Prettier", "prettier" },
    ["profile"] = { "profile", "shell" },
    ["renovate.json"] = { "Renovate config", "renovate" },
    ["requirements.txt"] = { "Editing a TEXT file", "pythontxt" },
    ["tsconfig.json"] = { "Editing a JSON file", "tsconfig" },
    ...
    java = { "Java", "java" },
    jl = { "Julia", "julia" },
    js = { "Editing a JAVASCRIPT file", "javascript" },
    json = { "Editing a JSON file", "json" },
    jsx = { "React", "react" },
    ...
    mdx = { "MDX", "mdx" },
    mjs = { "Editing a JAVASCRIPT file", "javascript" },
    ml = { "OCaml", "ocaml" },
    nim = { "Nim", "nim" },
    nix = { "Nix", "nix" },
    norg = { "Neorg", "neorg" },
    ...
    py = { "Editing a PYTHON file", "python" },
    r = { "R", "r" },
    raku = { "Raku", "raku" },
    rakudoc = { "Raku", "raku" },
    rakumod = { "Raku", "raku" },
    ...
    tk = { "Tcl/Tk", "tcl" },
    tl = { "Teal", "teal" },
    toml = { "Editing a TOML file", "toml" },
    ts = { "Editing a TYPESCRIPT file", "typescript" },
    tsx = { "React", "react" },
    txt = { "Editing a TEXT file", "txt" },
    ...
    xslt = { "XSLT", "markup" },
    yaml = { "Editing a YAML file", "yaml" },
    yml = { "Editing a YAML file", "yaml" },
    zig = { "Editing a ZIG file", "zig" },
